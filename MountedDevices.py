    ...
    def get_requirements(cls) -> List[interfaces.configuration.RequirementInterface]:
        return [
            ...
            requirements.StringRequirement(
                name="keysset", description="""Keys to extract and analyze {MountedDevices, AmcacheInventoryApplication, AmcacheInventoryApplicationFile}""", default=None, optional=False
            )
        ]
